      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed font-light text-center">Whether you're looking to collaborate, hire a developer, or discuss a project idea. I’m open to freelance opportunities, creative partnerships, or just chatting about how tech can solve real-world problems.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
