...
find docs/assets -name "*.js" -exec sed -i 's|"/assets/|"./assets/|g; s|"/icons/|"./icons/|g; s|"/code-institute-logo.png"|"./code-institute-logo.png"|g; s|"/malmo-university-logo.png"|"./malmo-university-logo.png"|g; s|"/zambia-university-logo.png"|"./zambia-university-logo.png"|g; s|"/brew-haven-logo.png"|"./brew-haven-logo.png"|g' {} \;
